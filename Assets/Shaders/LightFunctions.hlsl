    ...
    out InputData inputData)
{
    ...
    // Similar to GetNormalizedScreenSpaceUV:
    // 1. Use ComputeScreenPos to obtain a coordinate that preserves perspective correctness
    // 2. Divide by w manually ¡÷ this yields the same 0¡V1 UV as in the fragment shader
...
half4 CalculateBlinnPhong(in float3 positionWS, in half3 normalWS,     
    in float4 positionCS, 
    in half4 albedoColor)
{
     InputData inputData;
